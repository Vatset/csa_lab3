...
* Общий объем памяти составляет 2048 ячеек (2^11).
* Ячейка памяти с адресом 0 зарезервирована для вектора прерываний ввода.
* Начальное значение указателя стека установлено на адрес 2045, причем стек увеличивается в сторону уменьшения адресов.
* Ячейка памяти с адресом 2046 связана с устройством ввода.
* Ячейка памяти с адресом 2047 связана с устройством вывода.
